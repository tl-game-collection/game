...
public class PCLIPokerNtfFolieFGFGameOverInfo extends PCLIRoomGameOverInfo {
    ...
    public List<Long> threeAPlayerList = new ArrayList<>();      // 三A豹子玩家Uid
    public List<Long> singlePlayerList = new ArrayList<>();      // 顺金玩家Uid
    public long winPlayerUid;                                   // 赢家玩家uid
    public long timestamp;

    @Override
    public String toString() {
        return "PCLIPokerNtfFolieFGFGameOverInfo{" +
                "allGameOverInfo=" + allGameOverInfo +
                ", threePlayerList=" + threePlayerList +
                ", threeAPlayerList=" + threeAPlayerList +
