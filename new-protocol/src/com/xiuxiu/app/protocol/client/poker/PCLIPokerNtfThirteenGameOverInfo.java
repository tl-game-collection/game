...
public class PCLIPokerNtfThirteenGameOverInfo extends PCLIRoomGameOverInfo {
    ...
    public static class ShootList{
        ...
        public long shootScore;//对每个玩家得打枪分数
    ...
    @Override
    public String toString() {
        return "PCLIPokerNtfThirteenGameOverInfo{" +
