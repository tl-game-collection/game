...
public class PCLIPokerNtfTexasDeskInfo extends PCLIRoomDeskInfo {
    public List<Byte> cards = new ArrayList<>();        // 当前手牌
    public List<Byte> publicCards = new ArrayList<>();   //公牌        
    ...
    public int pot; // 底池
    public long timeout;//超时
    public long areaUid;//超时
    public Round round = new Round();
    public PCLIPokerNtfTexasBetInfo.Interest interest;//保险
    public Map<Long,Integer> lastRebet=new HashMap<>();//上一回合下注
    ...
    @Override
    public String toString() {
        return "PCLIPokerNtfTexasDeskInfo{" +
                "cards=" + cards +
