...
import com.xiuxiu.app.protocol.api.temp.player.AddNoRankList;
...
public class AddNoRankListHandler  implements HttpHandler {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        String body = new String(HttpServer.readBody(httpExchange), Charsetutil.UTF8);
        AddNoRankList info = JsonUtil.fromJson(body, AddNoRankList.class);
        ...
        do {
            ...
            Config.addNORANK(player.getUid());
            Logs.API.warn("添加%d进NORANK 时间:%s", info.playerUid, TimeUtil.format("yyyy-MM-dd HH:mm:ss.SSS", System.currentTimeMillis()));
        } while (false);
