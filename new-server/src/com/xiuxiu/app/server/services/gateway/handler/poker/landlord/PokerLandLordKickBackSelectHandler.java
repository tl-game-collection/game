...
public class PokerLandLordKickBackSelectHandler implements Handler {
    @Override
    public Object handler(Object owner, Object request) {
        ...
        if (null == room) {
            ...
            player.send(CommandId.CLI_NTF_POKER_LAND_LORD_KICK_BACK_SELECT_FAIL, ErrorCode.ROOM_NOT_EXISTS);
            return null;
        }
        if (null == info) {
        ...
        room.kickBackSelect(player, info.type);
        return null;
    }
}
