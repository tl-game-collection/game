...
public class PokerSGDealCardOkHandler implements Handler {
    @Override
    public Object handler(Object owner, Object request) {
        ...
        ErrorCode err = ((SGRoom) room).onAddDealCardPlayerOkCnt();
        Logs.ROOM.warn("%s 明牌抢庄首牌已经发完的玩家", player);
        if (ErrorCode.OK != err) {
            player.send(CommandId.CLI_NTF_POKER_SG_DEALCARD_OVER_FAIL, err);
        }
        return null;
    }
}
