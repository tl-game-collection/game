...
import com.xiuxiu.app.protocol.client.poker.PCLIPokerReqSGRebetInfo;
...
public class PokerSGRebetHandler implements Handler {
    @Override
    public Object handler(Object owner, Object request) {
        Player player = (Player) owner;
        PCLIPokerReqSGRebetInfo info = (PCLIPokerReqSGRebetInfo) request;
        ...
        ErrorCode err = ((SGRoom) room).onRebet(player, info.rebet);
        if (ErrorCode.OK != err) {
