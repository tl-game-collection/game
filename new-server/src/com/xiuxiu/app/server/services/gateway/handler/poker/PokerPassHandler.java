...
public class PokerPassHandler implements Handler {
    @Override
    public Object handler(Object owner, Object request) {
        ...
        if (null == room) {
            ...
            player.send(CommandId.CLI_NTF_POKER_PASS_FAIL, ErrorCode.ROOM_NOT_EXISTS);
            return null;
        }
        ErrorCode err = room.pass(player);
        if (ErrorCode.OK != err) {
            player.send(CommandId.CLI_NTF_POKER_PASS_FAIL, err);
        }
        return null;
    }
}
